...
export const posts = [
  ...
  },
  {
    ...
    excerpt:
      'Important security updates and best practices to keep your data safe.',
    ...
    content: [
      {
        ...
        children: [
          {
            _type: 'span',
            text: 'Security is our top priority. Here are the latest best practices and security updates.',
          },
        ],
        style: 'normal',
      },
...
// Helper functions to replace Sanity queries
...
export function getPostsCount(categorySlug = null) {
  if (!categorySlug) return posts.length
